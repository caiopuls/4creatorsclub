...
export default function NewHiringPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            router.push('/dashboard/jobs?type=hiring')
            router.refresh()
        } catch (err: any) {
            console.error(err)
    ...
    return (
        <div className="max-w-3xl mx-auto">
            ...
            <div className="mb-8">
                <h1 className="text-3xl font-bold text-white mb-2">Publicar Nova Vaga</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-8 bg-zinc-900/30 p-8 rounded-2xl border border-zinc-800">
                    ...
                    <div className="grid gap-4">
                        <div>
                            ...
                            <input
                                ...
                                placeholder="Ex: Designer UI/UX Pleno"
                ...
                <div className="pt-4">
                    ...
                    >
                        {loading ? <Loader2 className="animate-spin" /> : 'Publicar Vaga'}
                    </button>
                </div>
