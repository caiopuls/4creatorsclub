      ...
      <div className="py-20">
        ...
        >
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-[#d0d0d0]">
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4 mt-8">7. Limitação de Responsabilidade</h2>
              <p>
                O 4Creators Club não se responsabiliza por danos diretos, indiretos, incidentais, especiais ou consequenciais resultantes do uso ou incapacidade de usar nossos serviços. O uso do conteúdo é por sua conta e risco. Não garantimos resultados específicos decorrentes do uso dos materiais educacionais fornecidos.
              </p>
            </section>
